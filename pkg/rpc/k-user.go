...
func (p *UserServiceQueryUsersInBatchesArgs) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceQueryUsersInBatchesArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *UserServiceQueryUsersInBatchesArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *UserServiceQueryUsersInBatchesArgs) FastWrite(buf []byte) int {
	return 0
}

func (p *UserServiceQueryUsersInBatchesArgs) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "QueryUsersInBatches_args")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
	}
	offset += bthrift.Binary.WriteFieldStop(buf[offset:])
...
func (p *UserServiceQueryUsersInBatchesArgs) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("QueryUsersInBatches_args")
	if p != nil {
		l += p.field1Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *UserServiceQueryUsersInBatchesArgs) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *UserServiceQueryUsersInBatchesArgs) field1Length() int {
	l := 0
...
func (p *UserServiceQueryUsersInBatchesResult) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceQueryUsersInBatchesResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *UserServiceQueryUsersInBatchesResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *UserServiceQueryUsersInBatchesResult) FastWrite(buf []byte) int {
	return 0
}

func (p *UserServiceQueryUsersInBatchesResult) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "QueryUsersInBatches_result")
	if p != nil {
		offset += p.fastWriteField0(buf[offset:], binaryWriter)
	}
	offset += bthrift.Binary.WriteFieldStop(buf[offset:])
...
func (p *UserServiceQueryUsersInBatchesResult) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("QueryUsersInBatches_result")
	if p != nil {
		l += p.field0Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *UserServiceQueryUsersInBatchesResult) fastWriteField0(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetSuccess() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "success", thrift.LIST, 0)
		listBeginOffset := offset
...
func (p *UserServiceQueryUsersInBatchesResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
		l += bthrift.Binary.FieldBeginLength("success", thrift.LIST, 0)
		l += bthrift.Binary.ListBeginLength(thrift.STRUCT, len(p.Success))
...
func (p *UserServiceResetPasswordArgs) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *UserServiceResetPasswordArgs) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "password", thrift.STRING, 2)
	offset += bthrift.Binary.WriteStringNocopy(buf[offset:], binaryWriter, p.Password)
...
func (p *UserServiceResetPasswordArgs) field2Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("password", thrift.STRING, 2)
	l += bthrift.Binary.StringLengthNocopy(p.Password)
...
func (p *UserServiceQueryUsersInBatchesArgs) GetFirstArgument() interface{} {
	return p.Ids
}

func (p *UserServiceQueryUsersInBatchesResult) GetResult() interface{} {
	return p.Success
}
