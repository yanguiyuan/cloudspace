...
type Client interface {
	...
	QueryUsersInBatches(ctx context.Context, ids []int64, callOptions ...callopt.Option) (r []*rpc.User, err error)
...
func (p *kUserServiceClient) QueryUsersInBatches(ctx context.Context, ids []int64, callOptions ...callopt.Option) (r []*rpc.User, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.QueryUsersInBatches(ctx, ids)
}
